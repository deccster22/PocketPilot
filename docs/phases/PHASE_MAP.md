...
| `P7`        | canonical product         | `P7`                                                                  | Knowledge baseline                                               | partial | Baseline foundation now exists through `P7-K1`, the canonical `docs/knowledge/` corpus now exists through the follow-on normalization pass, and `P7-K2` now adds the first subordinate topic-detail surface, but the broader family remains incomplete                  |
