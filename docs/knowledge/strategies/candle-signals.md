...
### 1. Quick overview
Candle Signals is built around the idea that price candles can reveal short-term behavior in a compact, visual way.

**This strategy is trying to read the market’s body language, not treat candle shapes like fortune-telling symbols.**

### 2. Who this strategy tends to suit
It often suits users who:
- like visual price action
- are comfortable reading short-term clues directly from charts
- prefer market behavior over heavy indicator dependence
- want a strategy that helps explain why a moment feels different

### 3. What this strategy is trying to do
The core objective is to identify meaningful short-term clues through candles and small candle formations.
...
PocketPilot should help users learn candle behavior through live interpreted state changes rather than static textbook worship.
