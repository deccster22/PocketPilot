...
| `P7`        | canonical product         | `P7`                                                                  | Knowledge baseline                                               | partial | Baseline foundation now exists through `P7-K1`, and the canonical `docs/knowledge/` corpus now exists through the follow-on documentation import and normalization pass, but the broader family remains incomplete                                                      |
