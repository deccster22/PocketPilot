...
### 1. Quick overview
Momentum Pulse is built for markets that suddenly start moving faster.

**This strategy is trying to read acceleration, not just direction.**

### 2. Who this strategy tends to suit
It often suits users who:
- are comfortable with shorter time horizons
- do not mind monitoring the market more closely
- are interested in speed and participation rather than slower structural setups
- can stay disciplined when a fast move begins losing energy

### 3. What this strategy is trying to do
The core objective is to participate in a short-term directional move that is accelerating faster than usual.
...
PocketPilot should help answer whether short-term acceleration is strengthening, staying active, or beginning to fade.
