...
| `P9`        | canonical product         | `P9`                                                                  | Strategy Navigator and richer explanation layer                  | partial | `P9-S1` now lands the first thin Strategy Preview foundation, but the broader family remains incomplete                                                                                                                                                                 |
