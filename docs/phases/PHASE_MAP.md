...
| `P6`        | canonical product         | `P6`                                         | Alerts and message policy family                                 | partial | Current merged work includes the reorientation and Snapshot-briefing thread plus `P6-A1` through `P6-A3`, not full `P6` completion                                                                                                                                |
